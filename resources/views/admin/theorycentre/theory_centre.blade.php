                                ...
                                <tbody>
                                   @foreach($theorycentres as $theorycentre)
                                    <tr>
                                        ...
                                        <td>
                                            @if($theorycentre->status == 1) <a  href="{{ route('deactive.theorycentre',$theorycentre->id) }}"> <span class="badge bg-success">Success</span></a> @else  <a  href="{{ route('active.theorycentre',$theorycentre->id) }}"><span class="badge bg-warning">Deactive</span> </a> @endif
                                        </td>
                                        <td>
                                         <!-- Large modal -->
                                                            ...
                                                            <div class="p-4 border rounded">
                                                                <form action="{{ route('update.theorycentre',$theorycentre->id) }}" method="post" class="row g-3 needs-validation" novalidate>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <input type="text" name="centre_name" class="form-control" id="" value="{{ $theorycentre->centre_name }}" required>
