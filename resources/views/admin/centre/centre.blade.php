...
@section('content')
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">New Centre Form</h5>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="p-4 border rounded">
                                                                <form action="{{ route('centre.import') }}" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <br>
                                                                    <button class="btn btn-success">Import Centre Data</button>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    </div>
       ...
       {{--      @if ($errors->any())
            ...
            <hr/>
             @endif --}}
                <h6 class="mb-0 text-uppercase">List of Centres</h6>
                <hr/>
                <div class="card">
                    <div class="card-body">
                                ...
                                <tbody>
                                   @foreach($centres as $centre)
                                    <tr>
                                        ...
                                        <td>
                                            @if($centre->status == 1) <a  href="{{ route('deactive.centre',$centre->id) }}"> <span class="badge bg-success">Success</span></a> @else  <a  href="{{ route('active.centre',$centre->id) }}"><span class="badge bg-warning">Deactive</span> </a> @endif</td>
                                        <td>
                                         <!-- Large modal -->
