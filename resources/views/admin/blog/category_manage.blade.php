                       ...
                       <tbody>
                          @foreach($blogcates as $blogcate)
                           <tr>
                              <td>{{ $count++ }}</td>
                              <td>{{ $blogcate->name }}</td>
                              <td><img src="{{ asset('storage/app/public/'.$blogcate->image) }}" style="height: 50px; width: 50px;"></td>
                              <td> 
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="p-4 border rounded">
                                                                  <form action="{{ route('update.blogcate',$blogcate->id) }}" method="post" class="row g-3 needs-validation" novalidate>
                                                                   @csrf
                                                                   <div class="col-md-12">
                   ...
                   <div class="modal-body">
                       <div class="row">
                           <div class="col-xl-8 mx-auto"> 
                               ...
                               <hr/>
                               <div class="p-4 border rounded">
                                   <form action="{{ route('create.blogcate') }}" method="post" class="row g-3 needs-validation" novalidate>
                                       @csrf
                                       <div class="col-md-12">
