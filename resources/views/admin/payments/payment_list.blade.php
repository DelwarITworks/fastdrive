                        ...
                        <div class="table-responsive">
                            <table id="example2" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                   ...
                                   @if($payment->practical_id)
                                    <tr>
                                        <td>{{ $count }}</td>
                                        <td>{{ $payment->practical->name }}</td>
                                        <td>{{ $payment->practical->track_id }}</td>
                            ...
                            <div class="modal fade" id="exampleExtraLargeModal{{ $payment->id }}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('practical.partial.payment',$payment->id) }}" method="post" class="row g-3 needs-validation" novalidate>
                            ...
                            <div class="modal fade" id="exampleExtraLargeModal1{{ $payment->id }}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('practical.payment.refund',$payment->id) }}" method="post" class="row g-3 needs-validation" novalidate>
                                            <div class="modal-body">
                                                @csrf
                                                <div class="col-md-12 mt-3">
                                                    @php 
